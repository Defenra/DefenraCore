export const en = {
  ...
  ipCheck: {
    title: "IP Check",
    description: "Check IP geolocation and routing information",
    input: {
    ...
    routing: {
      ...
      exactMatch: "Exact location match",
      nearestFallback: "Nearest agent fallback",
      noAgent: "No agent available (origin fallback)",
      clientLocation: "Client Location",
      distance: "Distance to Agent",
      selectedAgent: "Selected Agent",
      alternativeAgents: "Alternative agents in region ({{count}})",
      noAgentAvailable: "No agent available for this region",
      nxdomainWarning: "This IP may resolve to NXDOMAIN",
    },
    agent: {
      name: "Name",
      ip: "IP Address",
